    ...
    <nav id="navbar" class="navbar navbar-expand-lg fixed-top border-end custom-navbar border-bottom">
        <div class="w-100 d-flex flex-wrap justify-content-between align-items-center px-3 px-md-5 gap-3">
            ...
            <a class="navbar-brand fw-bold navy" href="../index.php">
                ...
                <span id="nav-logo" class="d-flex align-items-center">OHIO Global Company Limited</span>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navMenu">
                <div class="w-100 d-flex justify-content-around align-items-center px-5">
                    <ul class="navbar-nav navy">
                        <li class="nav-item"><a class="nav-link " href="../index.php" id="nav-home"
                                style="font-size: 1px">Home</a>
                        </li>
                        <li class="nav-item"><a class="nav-link fs-4" href="../index.php#about" id="nav-about">About</a>
                        </li>
                        <li class="nav-item"><a class="nav-link active fs-4" href="../activity.php"
                                id="nav-activity">Activity</a>
                        </li>
                        <li class="nav-item"><a class="nav-link fs-4" href="../index.php#service"
                                id="nav-service">Service</a></li>
                        <li class="nav-item"><a class="nav-link fs-4" href="../index.php#contact"
    ...
    <footer class="text-dark border-top pt-5 pb-3">
        <div class="container">
            ...
            <div class="text-center border-top pt-3">
                <p class="mb-0">&copy;OHIO Global Company Limited. All rights reserved.</p>
            </div>
        </div>
    </footer>
    <!-- Lightbox Overlay -->
