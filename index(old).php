...
<body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-offset="70" tabindex="0">
            ...
            <div class="collapse navbar-collapse" id="navMenu">
                ...
                <div class="w-100 d-flex justify-content-around align-items-center px-5">
                    ...
                    <ul class="navbar-nav navy">
                        <li class="nav-item">
                            <a class="nav-link active" href="index.php" id="nav-home" style="color:#031867;">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fs-4" href="#about" id="nav-about" style="font-size : 18px; color: #031867;">About</a>
                        </li>
                        <li class="nav-item">
    ...
    <section id="home" class="text-center banner mt-2 d-flex justify-content-center align-items-center"
        ...
        <div class="container">
            <h1 class="m-3 pt-2" id="banner-title">OHIO Global International</h1>
...
<div class="text-center pt-5 d-flex justify-content-center" style="background-color: #f8f9fa;">
    ...
    <footer class="text-dark bordertop p-5">
        <div class="container">
                        ...
                        <div class="col-4">
                            <ul class="list-unstyled">
                                <li class="nav-item mb-2">
                                    <a class="nav-link fs-4 p-0" href="index.php" id="footer-home">Home</a>
                                </li>
                                <li class="nav-item mb-2">
                                    <a class="nav-link fs-4 p-0" href="#about" id="footer-about">About</a>
                                </li>
                                <li class="nav-item mb-2">
                                    <a class="nav-link fs-4 p-0" href="activity.php" id="footer-activity">Activity</a>
                                </li>
                                <li class="nav-item mb-2">
                                    <a class="nav-link fs-4 p-0" href="#service" id="footer-service">Service</a>
                                </li>
                                <li class="nav-item mb-2">
                                    <a class="nav-link fs-4 p-0" href="#contact" id="footer-contact">Contact</a>
                                </li>
                            </ul>
                        </div>
