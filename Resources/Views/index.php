...
<body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-offset="70" tabindex="0">
  ...
  <section id="home" class="text-center banner mt-2"
    ...
    <div class="container">
      ...
      <p class="lead mb-0 mt-4" id="banner-p">Unlock a world of opportunity in Japan with OHIO Global Company.,Ltd. As a
        trusted agency, we empower Myanmar professionals to achieve their career aspirations by providing comprehensive
  ...
  <section class="about py-5" id="about">
      ...
      <div class="row align-items-center mb-5">
        ...
        <div class="col-md-6 mb-4 mb-md-0">
          <p id="about-p1" data-aos="fade-up" data-aos-duration="2500" class="font-dark">
            OHIO Global was founded in 2022, our company helps people achieve their dream jobs abroad. We specialize in
            connecting skilled individuals with international employment opportunities by bridging the gap between
            global talent and overseas employers. As an overseas employment agency, our mission is to empower foreign
            workers through ethical recruitment, reliable service, and full support throughout their journey to work and
            live abroad.
          </p>
          <p id="about-p2" data-aos="fade-up" data-aos-duration="2000" class="font-dark">Over time, our unwavering
            dedication to ethical
            practices and comprehensive support allowed us to grow into a trusted leader. Each successful placement
            reinforced our commitment to excellence and empowered countless individuals.</p>
          <p id="about-p3" data-aos="fade-up" data-aos-duration="1500" class="font-dark">Today, we proudly stand as a
            respected agency,
            with a history defined by integrity and the flourishing careers of those we've guided. Our mission remains
            steadfast: to continue facilitating meaningful professional paths in Japan for the people of Myanmar.</p>
    ...
    <div class="no-padding">
      ...
      <div class="d-flex overflow-auto gap-3 pb-4 px-3" style="scroll-snap-type: x mandatory; scroll-behavior: smooth;">
    ...
    <div class="container-fluid row align-items-center">
      ...
      <div class="col-12  text-center no-padding">
        ...
        <p id="service-p1" data-aos="zoom-out-left" data-aos-duration="2000"
          ...
          We are a government-licensed employment placement agency and registered support organization. From language
          and skills assessment to visa processing, pre-departure training, and post-arrival support, we guide both
          workers and companies through every step of the hiring and relocation process. Our goal is to ensure a smooth,
      ...
      <div class="container mt-5">
        <div class="row align-items-center no-padding">
          <div class="col-md-6">
            <!-- Carousel -->
            <div id="imageCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="4250">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="../../Public/images/Job.jpg" style="height: 350px; object-fit: cover; border-radius: 15px;"
                    class="d-block w-100" alt="Image 1">
                </div>
                <div class="carousel-item">
                  <img src="../../Public/images/language_school.jpg"
                    style="height: 350px; object-fit: cover;  border-radius: 15px;" class="d-block w-100" alt="Image 2">
                </div>
                <div class="carousel-item">
                  <img src="../../Public/images/uni.jpg" style="height: 350px; object-fit: cover;  border-radius: 15px;"
  ...
  <footer class="text-dark bordertop pt-5 pb-3">
    <div class="container">
      <div class="row align-items-start custom-footer">
              ...
              <ul class="list-unstyled">
                <li>
                  <a href="https://www.ohiomyanmar.com/" class="nav-link p-1 fs-5">
                    <img src="../../Public/images/ohio-logo.ico" alt="Ohio" height="50px" width="50px">
                    <span>
                ...
                <li>
                  <a href="https://www.jktmyanmarint.com/" class="nav-link p-1 fs-5">
                    <img src="../../Public/images/jkt-logo.jpg" alt="JKT" height="50px" width="50px">
                    <span>
        ...
        <div class="col-12 col-md-6 d-flex flex-column flex-md-row justify-content-around align-items-center mb-3">
          ...
          <div class="mb-3 text-center">
            <a class="navbar-brand fw-bold navy gap-2 d-flex flex-column align-items-center" href="index.php">
              <img src="../../Public/images/LOGO.jpg" class="img-fluid mb-2" style="height: 75px;" alt="Logo">
