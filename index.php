...
<head>
    ...
    <link rel="stylesheet" href="assets/css/activity-style.css" />
...
<body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-offset="70" tabindex="0">
    ...
    <nav id="navbar" class="navbar navbar-expand-lg fixed-top border-end custom-navbar border-bottom">
        <div class="w-100 d-flex flex-wrap justify-content-between align-items-center px-3 px-md-5 gap-3">
            ...
            <a class="navbar-brand fw-bold navy" href="index.php">
                <img src="assets/images/logo.jpg" class="img-fluid" style="height: 55px;" alt="">
                <span id="nav-logo" class="d-flex align-items-center">
                    OHIO Global Company Limited
                </span>
            ...
            <div class="collapse navbar-collapse" id="navMenu">
                ...
                <div class="w-100 d-flex justify-content-around align-items-center px-5">
                    ...
                    <ul class="navbar-nav navy">
                        <li class="nav-item">
                            <a class="nav-link active" href="index.php" id="nav-home" style="font-size : 18px; color:#031867;">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#about" id="nav-about" style="font-size : 18px; color: #031867;">About</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="activity.php" id="nav-activity" style="font-size : 18px; color: #031867;">Activity</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#service" id="nav-service" style="font-size : 18px; color: #031867;">Service</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#contact" id="nav-contact" style="font-size : 18px; color: #031867;">Contact</a>
                        </li>
                    </ul>
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <button class="lang-btn active">
                            <img src="assets/images/UK_flag.png" height="20px" width="25px" alt="UK Flag"
                                onclick="setLanguage('en')">
                        </button>
                        <button class="lang-btn">
                            <img src="assets/images/Japan_Flag.png" height="20px" width="25px" alt="JP Flag"
    ...
    <section id="home" class="text-center banner mt-2 d-flex justify-content-center align-items-center"
        style="padding: 70px 0 16px 0; background: linear-gradient(to right, #002147, #004080); color: white;">

        <div class="container">
            <h2 class="m-3 pt-2" id="banner-title">OHIO Global International</h2>
    ...
    <section class="about py-3" id="about">
        <div class="container">
            ...
            <div class="row align-items-center mb-5">
                ...
                <!-- Right Column: Image -->
                <div class="col-md-6">
                    <img src="assets/images/New-banner.jpg" alt="About Us" class="img-fluid rounded shadow">
                </div>
            </div>
        </div>
        <div class="no-padding">
            ...
            <div class="d-flex overflow-auto gap-3 pb-4 px-3"
                ...
                <div class="board-member text-center p-4 bg-opacity-25 rounded-4"
                    ...
                    <img src="assets/images/managing-director.jpg" class="img-fluid rounded-circle mb-2"
                ...
                <div class="board-member text-center p-4 bg-opacity-25 rounded-4"
                    ...
                    <div class="d-flex flex-column align-items-center">
                        <img src="assets/images/director(1).jpg" class="img-fluid rounded-circle mb-2"
                ...
                <div class="board-member text-center p-4 bg-opacity-25 rounded-4"
                    style="scroll-snap-align: center; width: 100%;">
                    <img src="assets/images/director(2).jpg" class="img-fluid rounded-circle mb-2"
...
<div class="text-center pt-5 d-flex justify-content-center" style="background-color: #f8f9fa;">
            ...
            <section id="image-carousel" class="splide">
                <div class="splide__track">
                    <ul class="splide__list">
                        <li class="splide__slide"><img src="assets/images/Gallery1.jpg" alt=""></li>
                        <li class="splide__slide"><img src="assets/images/Gallery2.jpg" alt=""></li>
                        <li class="splide__slide"><img src="assets/images/Gallery3.jpg" alt=""></li>
                        <li class="splide__slide"><img src="assets/images/Gallery12.jpg" alt=""></li>
                        <li class="splide__slide"><img src="assets/images/Gallery14.jpg" alt=""></li>
                        <li class="splide__slide"><img src="assets/images/Gallery21.jpg" alt=""></li>
                    </ul>
                </div>
            </section>
        </div>

        <!-- See More button — stays INSIDE .container -->
        <div class="d-flex justify-content-center mt-4">
            <a href="activity.php" class="btn mb-5" id="member-btn">See more</a>
        </div>

    </div> <!-- closes .container -->
</div> <!-- closes .text-center pt-5 section -->
    ...
    <section id="service" class="mb-2">
        <div class="container-fluid row align-items-center">
            ...
            <div class="col-12  text-center no-padding">
                <h2 id="service-title" class="mb-5 font-dark">Our Services</h2>
                        ...
                        <div id="imageCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="4000">
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item">
                                    <img src="assets/images/Gallery34.jpg"
                                        style="height: 350px; object-fit: cover;  border-radius: 15px;"
    ...
    <div class="pb-5 pt-5 text-center border-top pt-3">
        <div class="container text-center">
            <h2 id="service-mt" class="mb-5 font-dark">Our Mission</h2>
    ...
    <section id="contact" class="footer text-white no-padding">
        <div class="container no-padding">
            <h2 class="text-center no-padding contact-text" id="contact-title">Contact Us</h2>
            <div class="row">
                <!-- Left Column: Paragraph -->
                <div class="col-lg-6 col-md-12 mb-4 mb-md-0">
                    <div>
                        <h4 class="mb-3 contact-text" id="contact-des">Our Location</h4>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="container my-4">
                        <div class="d-flex flex-column align-items-start mx-auto" style="max-width: 400px; gap: 1rem;">
                            <div class="d-flex align-items-center mb-2 w-100">
                                <i class="fa-solid fa-envelope custom-icon me-3 contact-text"></i>
                                <div>
                                    <h4 class="mb-1 contact-text" id="contact-email">Email:</h4>
                                    <p class="mb-0 contact-text">ohioglobalco.ltd@gmail.com</p>
                                </div>
                            </div>
                            <div class="d-flex align-items-center mb-3">
                                <i class="fa-solid fa-business-time custom-icon me-3 contact-text"></i>
                                <div>
                                    <h4 class="mb-1 contact-text" id="contact-hour">Working Hours:</h4>
                                    <p class="mb-0 contact-text">Mon–Sun: 9am–5pm</p>
                                </div>
                            </div>
                            <div class="d-flex align-items-center mb-3">
                                <i class="fa-solid fa-phone custom-icon me-3 contact-text"></i>
                                <div>
                                    <h4 class="mb-1 contact-text" id="contact-phone">Phone:</h4>
                                    <p class="mb-0 contact-text">+959 446600994</p>
                                    <p class="mb-0 contact-text">+959 446600995</p>
                                </div>

                            </div>
                            <div class="d-flex align-items-center mb-3 w-100">
                                <i class="fa-solid fa-location-dot contact-text"></i>
                                <div class="ms-3">
                                    <h4 class="mb-1 contact-text" id="contact-footeraddress">Company Address:</h4>
                                    <p class="mb-0 contact-text" id="contact-address">No. 74, First Floor, Than Ta Dar
                                        Street, <br>
                                        Sanchaung Township,
                                        Yangon.
                                    </p>
    ...
    <footer class="text-dark bordertop p-1">
                        ...
                        <div class="col-4">
                            <ul class="list-unstyled">
                                <li class="nav-item mb-2">
                                    <a class="nav-link p-0" href="index.php" id="footer-home"style="font-size : 18px; color: #031867;">Home</a>
                                </li>
                                <li class="nav-item mb-2">
                                    <a class="nav-link p-0" href="#about" id="footer-about"style="font-size : 18px; color: #031867;">About</a>
                                </li>
                                <li class="nav-item mb-2">
                                    <a class="nav-link p-0" href="activity.php" id="footer-activity"style="font-size : 18px; color: #031867;">Activity</a>
                                </li>
                                <li class="nav-item mb-2">
                                    <a class="nav-link p-0" href="#service" id="footer-service"style="font-size : 18px; color: #031867;">Service</a>
                                </li>
                                <li class="nav-item mb-2">
                                    <a class="nav-link p-0" href="#contact" id="footer-contact"style="font-size : 18px; color: #031867;">Contact</a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul class="list-unstyled">
                                <li>
                                    <a href="https://www.ohiomyanmar.com/" class="nav-link p-1 fs-5">
                                        <img src="assets/images/ohio-logo.ico" alt="Ohio" height="50px" width="50px">
                                        <span>
                                ...
                                <li>
                                    <a href="https://www.jktmyanmarint.com/" class="nav-link p-1 fs-5">
                                        <img src="assets/images/jkt-logo.jpg" alt="JKT" height="50px" width="50px">
                                        <span>
                ...
                <div
                    ...
                    <div class=" mb-3 text-center">
                        <a class="navbar-brand fw-bold navy gap-2 d-flex flex-column align-items-center"
                            href="index.php">
                            <img src="assets/images/LOGO.jpg" class="img-fluid mb-2" style="height: 75px;" alt="Logo">
                            <span id="footer-logo">OHIO Global Company Limited</span>
                        </a>
                    </div>
...
<div class="text-center border-top pt-3">
    <p class="mb-0">&copy; <?php echo date("Y"); ?> Ohio Global International. All rights reserved.</p>
</div>
    </div>
    </footer>
